...
import { Colour, FontType, Tsize, View, Aos } from "../global";
...
function Settings() {
 ...
 return (
  <div>
   ...
   <IonItemDivider style={{ backgroundColor: `${color2}`, color: `${color3}` }}>
    <IonLabel style={{ fontFamily: `${fon}` }}>Other Setings</IonLabel>
   </IonItemDivider>
   <IonItem color={clr}>
    <IonLabel>Keep the Song screen awake</IonLabel>
    <IonCheckbox checked={aos} onIonChange={(e) => setAos(e.detail.checked)} />
   </IonItem>
